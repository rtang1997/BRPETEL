##Code for simulation of Extrinsic mean estimation on Special Orthogonal Group
library(pracma)
library(MASS)
n=500
covpp90=0
covpp95=0
theta_true=c(0.7072880, -0.7069255,  0.7069255,  0.7072880)
D=4
d=1
covpp90=0
covpp95=0
...
###################Projection function  (solving unit local parametrization) ##################
...
for(i in 1:n)
{theta=rnorm(1,pi/4,0.5)
X[i,]=c(cos(theta),-sin(theta),sin(theta),cos(theta))}
